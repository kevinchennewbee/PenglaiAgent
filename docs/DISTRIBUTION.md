...
> Apple Silicon boundary. It is not the current release plan. The current
> 0.6.6 three-target contract is in `release-contract.json` and
> `docs/0.6.6/ACCEPTANCE_DELTA.md`; Intel Mac is excluded from this release.
