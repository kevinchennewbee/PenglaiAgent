...
| DSH IM | rewrite-source `@xmanrui/dsh-im@4.17.1` / `464c0a9…` | npm latest **4.18.1** / `d01bd3450c6d17db2b3386ec44ffa474fd15b03e` (2026-09-10). Git HEAD **`606ced1b5e4f02fe4a1afc9462014f3db1176396`** adds bot aliases and is **not** npm 4.18.1. Declared DSH compatibility still stops at `0.1.5-alpha.1` and does not name rc.1. | **Keep first-party rewrite.** Track 4.18.1 + unpublished alias HEAD inside `@penglai/im`. Do not install the dsh-im runtime, copy `lib/`/`bin/`/`cordis.patch.yml`, add `/api/dsh-im/*`, WhatsApp, wecom-app, or a second Office. Optional Darwin iMessage is authorized (ADR 0046). Telegram Rich Draft is not adopted. |
