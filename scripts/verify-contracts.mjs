...
const cohortBytes = readFileSync(join(ROOT, "docs/0.6.6/DSH_NPM_COHORT.json"));
...
if (
  ...
  console.error("0.6.6 DSH npm cohort is missing the current source or registry identity");
  process.exit(1);
}
