# Penglai 0.6.3 on UnionTech UOS 20 LoongArch

Penglai 0.6.3 plans one `loongarch64` `.deb` for UnionTech UOS 20 Professional
...
alpha.2, all in-scope first-party plugins, Memory, Mnemon, native add-ons,
...
Workspace, Memory, and optional in-scope plugins. LibreOffice, Office/PDF,
