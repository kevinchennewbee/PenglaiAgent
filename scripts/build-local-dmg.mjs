#!/usr/bin/env node
/**
 * Community-verified macOS DMG for Penglai 0.5.10.
...
const TARGETS = {
  "darwin-arm64": {
    ...
    dmg: "dist/Penglai_0.5.10_macos_aarch64.dmg",
    from: "dist/Penglai-v0.5.10-arm64-from-dmg",
  },
  "darwin-x64": {
    out: "dist/Penglai-v0.5.10-x64",
    dmg: "dist/Penglai_0.5.10_macos_x64.dmg",
    from: "dist/Penglai-v0.5.10-x64-from-dmg",
  },
};
