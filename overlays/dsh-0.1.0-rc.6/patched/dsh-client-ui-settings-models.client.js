window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		const WELCOME_NOTICE_VERSION = "penglai-0.5.0.1";
		/** The complete editable internal-testing notice in both supported GUI locales. */
		const WELCOME_NOTICE_COPY = {
			zh: {
				title: "欢迎使用蓬莱",
				body: "欢迎使用蓬莱 0.5.0。这是基于官方 DeepSeek Harness 的本机桌面发行版：引导完成后，主窗口就是蓬莱品牌化、能力不删减的 official DSH Web。\n\n本机构建、community-verified、ad-hoc 签名、未公证。API 密钥与即时通讯凭据只保存在本机 app-private YAML。请不要关闭系统安全机制。官方 DSH 仍会持续演化，蓬莱保留其开源归属。",
				continueLabel: "继续"
			},
			en: {
				title: "Welcome to Penglai",
				body: "Welcome to Penglai 0.5.0. This is a local desktop distribution of official DeepSeek Harness. After onboarding, the main window is Penglai-branded official DSH Web with no official capabilities removed.\n\nThis build is community-verified, ad-hoc signed, and not notarized. API keys and messaging credentials stay in a local app-private YAML file. Do not disable system security features. Official DSH will keep evolving; Penglai retains that attribution.",
