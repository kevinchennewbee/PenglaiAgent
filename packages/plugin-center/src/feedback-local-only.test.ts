...
test("0.6.5 lets the enabled official feedback client register truthful local-only copy", () => {
...
test("0.6.5 enables exactly one official feedback row without Plugin Center injection", () => {
