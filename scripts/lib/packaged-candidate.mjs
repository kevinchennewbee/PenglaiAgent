...
export const PACKAGED_TARGETS = Object.freeze({
  "darwin-aarch64": Object.freeze({
    ...
    appRelative: "dist/Penglai-v0.5.6-arm64-from-dmg/Penglai.app",
    dmgRelative: "dist/Penglai_0.5.6_macos_aarch64.dmg",
  }),
  "darwin-x86_64": Object.freeze({
    buildTarget: "darwin-x64",
    appRelative: "dist/Penglai-v0.5.6-x64-from-dmg/Penglai.app",
    dmgRelative: "dist/Penglai_0.5.6_macos_x64.dmg",
  }),
  "win32-x86_64": Object.freeze({
    buildTarget: "win32-x64",
    appRelative: "dist/Penglai-v0.5.6-win32-x64/Penglai",
    dmgRelative: "dist/Penglai_0.5.6_windows_x64_setup.exe",
  }),
});
