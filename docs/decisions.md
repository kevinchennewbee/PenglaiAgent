...
### D-067 — 0.5.11 冻结 rc.1 cohort，并授权改写产品身份后发布

- 日期：2026-09-07。
- 决定：0.5.11 冻结官方 DSH `0.1.2-rc.1` / `dsh-v0.1.2-rc.1` /
  ...
  随该 cohort 保留。Owner 已授权把产品身份、`package.json` 与 `release-contract.json`
  改为 **0.5.11**，并完成三端原生构建与十项附件发布。已发布的 **v0.5.10** tag 与附件
  保持不可变。
