				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [wide && (0, react_jsx_runtime.jsx)("button", {
							...
							children: (0, react_jsx_runtime.jsxs)("span", { "data-penglai-wordmark": "1", style: { display: "inline-flex", alignItems: "center", gap: "8px" }, children: [(0, react_jsx_runtime.jsx)("img", { src: "/penglai-brand/logo-64.png", alt: "", width: 22, height: 22, style: { width: "22px", height: "22px", borderRadius: "5px", objectFit: "cover" } }), (0, react_jsx_runtime.jsx)("span", { children: "蓬莱" })] })
							...
							children: (0, react_jsx_runtime.jsxs)("button", {
								...
								children: [!wide && (0, react_jsx_runtime.jsx)("img", {
									className: SidebarRoot_module_css_default.railFish,
									src: "/penglai-brand/logo-64.png",
									alt: "蓬莱",
									width: 24,
									height: 24,
