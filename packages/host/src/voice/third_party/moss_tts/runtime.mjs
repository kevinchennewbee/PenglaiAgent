...
var BrowserOnnxTtsRuntime = class {
  ...
  async createOrtSession(relativePath, externalDataRelativePaths = []) {
    const modelPath = path.join(this.localPathRoot, normalizeRelativePath(relativePath));
  ...
  async ensureTokenizerLoaded() {
    ...
    await tokenizer.load(path.join(this.localPathRoot, tokenizerRelativePath));
