...
| P058-050 | Distribution title startup race | Source/UI/native | IN_PROGRESS | Apple Silicon run `33299433051` completed installer, fuses, welcome, and all plugin lifecycle phases but observed an upstream title before `DOMContentLoaded`; the preload now owns the title immediately and watches the document tree from startup; replacement installed CI remains |
