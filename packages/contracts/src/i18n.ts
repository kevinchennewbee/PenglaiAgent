...
export const PENGLAI_I18N = {
  zh: {
    ...
    memoryTitle: "蓬莱记忆",
    aboutTitle: "关于蓬莱",
    aboutVersion: "版本 0.5.8",
    aboutDsh: "核心：DeepSeek Harness 0.1.2-alpha.1（固定官方源码）",
    ...
    pluginNoArbitraryInstall: "0.5.8 只安装蓬莱签名目录中的插件，不提供任意 URL、npm 或 Git 安装。",
  },
  en: {
    appName: "Penglai",
    appNameFull: "Penglai",
    ...
    aboutVersion: "Version 0.5.8",
    aboutDsh: "Core: DeepSeek Harness 0.1.2-alpha.1 (fixed official source)",
    ...
    pluginNoArbitraryInstall: "0.5.8 installs only plugins from the Penglai-signed catalog. Arbitrary URL, npm, or Git install is not offered.",
  },
} as const;
