...
export const PENGLAI_I18N = {
  zh: {
    ...
    memoryTitle: "蓬莱记忆",
    aboutTitle: "关于蓬莱",
    aboutVersion: "版本 0.6.6",
    aboutDsh: "核心：DeepSeek Harness 0.1.7-alpha.2（固定官方发行包）",
    aboutTrust: "社区验证发行：macOS ad-hoc 未公证，Windows 无 Authenticode。不是静默自动更新。DSH 插件与本地 DSH 进程共享权限；内置蓬莱插件随应用审核分发，第三方插件通过官方 DSH 管理器安装并需用户确认。权限字段不是操作系统沙箱。",
    ...
    imOfferTitle: "连接消息渠道",
    imOfferHint: "手机消息插件已随包启用，但不会自动连接任何账号。可现在连接微信或配置飞书，也可稍后在消息连接中完成。",
    imWeixin: "连接微信",
    imFeishu: "配置飞书",
    updateTitle: "更新",
    uninstallTitle: "存储与卸载",
    pluginSharedProcess: "DSH 插件与本地 DSH 进程共享权限；权限列表用于审核与确认，不是沙箱。",
    pluginNoArbitraryInstall: "0.6.6 使用官方 DSH 插件管理器。安装第三方插件及允许构建脚本分别需要明确确认。",
  },
  en: {
    appName: "Penglai",
    appNameFull: "Penglai",
    ...
    aboutVersion: "Version 0.6.6",
    aboutDsh: "Core: DeepSeek Harness 0.1.7-alpha.2 (pinned official packages)",
    aboutTrust: "Community-verified: macOS ad-hoc not notarized, Windows no Authenticode. This is not silent auto-update. DSH plugins share the local DSH process. Bundled Penglai plugins are reviewed with the app; third-party plugins use the official DSH manager with user consent. Permission fields are not an OS sandbox.",
    ...
    imOfferHint: "Mobile Messaging is bundled and enabled, but no account connects automatically. Connect Weixin or configure Feishu now, or do so later in Messaging.",
    ...
    pluginNoArbitraryInstall: "0.6.6 uses the official DSH Plugin Manager. Installing a third-party plugin and allowing build scripts require separate explicit confirmation.",
  },
} as const;
