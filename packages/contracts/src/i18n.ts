...
export const PENGLAI_I18N = {
  zh: {
    ...
    pluginNoArbitraryInstall: "0.6.2 只安装蓬莱签名目录中的插件，不提供任意 URL、npm 或 Git 安装。",
  },
  en: {
    appName: "Penglai",
    appNameFull: "Penglai",
    ...
    pluginNoArbitraryInstall: "0.6.2 installs only plugins from the Penglai-signed catalog. Arbitrary URL, npm, or Git install is not offered.",
  },
} as const;
