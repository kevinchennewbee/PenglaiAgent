...
export const PENGLAI_I18N = {
  zh: {
    ...
    ttsTitle: "蓬莱语音合成",
    aboutTitle: "关于蓬莱",
    aboutVersion: "版本 0.5.0",
    aboutDsh: "核心：DeepSeek Harness 0.1.0-rc.8",
    aboutTrust: "社区验证发行：macOS ad-hoc 未公证，Windows 无 Authenticode。不是静默自动更新。",
  ...
  en: {
    ...
    aboutVersion: "Version 0.5.0",
    aboutDsh: "Core: DeepSeek Harness 0.1.0-rc.8",
    aboutTrust: "Community-verified: macOS ad-hoc not notarized, Windows no Authenticode. This is not silent auto-update.",
