...
- **2026-06-17** — v0.2.9: proactive companion and multimodal hardening: `present` mode, abilities status, vision endpoint fix, batched file preflight, chunked voice transcription, audit-path cleanup, and update-remote detection.
