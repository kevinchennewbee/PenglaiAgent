...
export const PINNED_PLUGIN_DSH = "0.1.3-alpha.2" as const;
...
export const FIRST_PARTY_PLUGIN_METADATA: readonly PluginCatalogMetadata[] =
  Object.freeze([
    ...
    },
    {
      ...
      packageFile: `penglai-plugin-reference-${RELEASE}.tgz`,
    ...
    },
    {
      ...common,
      id: "@penglai/asr",
      packageFile: `penglai-asr-${RELEASE}.tgz`,
    ...
    },
    {
      ...common,
      id: "@penglai/memory",
      packageFile: `penglai-memory-${RELEASE}.tgz`,
      capabilities: [
        "layered-memory",
        "knowledge-graph",
        "authorized-sources",
