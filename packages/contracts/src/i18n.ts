...
export const PENGLAI_I18N = {
  zh: {
    ...
    memoryTitle: "蓬莱记忆",
    aboutTitle: "关于蓬莱",
    aboutVersion: "版本 0.5.10",
    aboutDsh: "核心：DeepSeek Harness 0.1.3-alpha.2（固定官方发行包）",
    ...
    pluginNoArbitraryInstall: "0.5.10 只安装蓬莱签名目录中的插件，不提供任意 URL、npm 或 Git 安装。",
  },
  en: {
    appName: "Penglai",
    appNameFull: "Penglai",
    ...
    aboutVersion: "Version 0.5.10",
    aboutDsh: "Core: DeepSeek Harness 0.1.3-alpha.2 (pinned official packages)",
    ...
    pluginNoArbitraryInstall: "0.5.10 installs only plugins from the Penglai-signed catalog. Arbitrary URL, npm, or Git install is not offered.",
  },
} as const;
