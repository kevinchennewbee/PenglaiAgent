...
|---|---|---|---|---|---|---|
| AnySearch | anysearch-team/anysearch-dsh | dce7a51 | MIT | pending rc.2 installed | QUARANTINED | needs official credentials, network allowlist, and rc.2 installed PASS |
