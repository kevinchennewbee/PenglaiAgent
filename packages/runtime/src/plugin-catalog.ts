...
export const PINNED_PLUGIN_DSH = "0.1.2-rc.1" as const;
  ...
  Object.freeze([
    {
      ...
      packageFile: "penglai-plugin-center-0.5.10.tgz",
    ...
    },
    {
      ...common,
      id: "@penglai/im",
      packageFile: "penglai-im-0.5.10.tgz",
    ...
    },
    {
      ...
      packageFile: "penglai-plugin-reference-0.5.10.tgz",
    ...
    },
    {
      ...common,
      id: "@penglai/asr",
      packageFile: "penglai-asr-0.5.10.tgz",
    ...
    },
    {
      ...common,
      id: "@penglai/moss-tts",
      packageFile: "penglai-moss-tts-0.5.10.tgz",
    ...
    },
    {
      ...common,
      id: "@penglai/memory",
      packageFile: "penglai-memory-0.5.10.tgz",
      capabilities: [
        "layered-memory",
        "knowledge-graph",
        "authorized-sources",
    ...
    },
    {
      ...common,
      id: "@penglai/office",
      packageFile: "penglai-office-0.5.10.tgz",
    ...
    },
    {
      ...common,
      id: "@penglai/budget",
      packageFile: "penglai-budget-0.5.10.tgz",
    ...
    },
    {
      ...
      packageFile: "penglai-companion-0.5.10.tgz",
