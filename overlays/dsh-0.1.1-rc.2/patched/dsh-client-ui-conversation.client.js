window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function penglaiVoiceFromSource(source) {
if (source?.kind !== "user" || source?.schema !== 1 || source?.voice === void 0) return void 0;
const durationMs = Number(source.voice.durationMs);
if (!Number.isFinite(durationMs) || durationMs <= 0 || durationMs > 18e4) return void 0;
return { durationMs, adapter: source.adapter === "feishu" ? "Feishu" : source.adapter === "weixin" ? "Weixin" : "IM" };
}
function penglaiVisibleVoiceContent(content, voice) {
if (voice === void 0 || !Array.isArray(content) || content.length < 2) return content;
const first = content[0];
if (first?.type !== "text" || typeof first.text !== "string" || !first.text.startsWith("[PENGLAI LOCAL ASR METADATA - NOT USER-AUTHORED]\n")) return content;
return content.slice(1);
}
function UserStyleBubble({ content, source, renderMessageImages, actions, pending = false, referenceLabels = [], t }) {
			const voice = penglaiVoiceFromSource(source);
			const { text, images, rest } = contentParts(penglaiVisibleVoiceContent(content, voice));
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						showBubble && (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [voice !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
"data-penglai-im-voice": voice.adapter.toLowerCase(),
style: { display: "flex", alignItems: "center", gap: 8, minWidth: 150, marginBottom: text ? 6 : 0, fontSize: 13, fontWeight: 500 },
children: [(0, react_jsx_runtime.jsx)("span", { "aria-hidden": true, style: { fontSize: 16 }, children: "🎙" }), (0, react_jsx_runtime.jsx)("span", { "aria-hidden": true, style: { letterSpacing: 1.5 }, children: "▂▄▆█▆▄▂" }), (0, react_jsx_runtime.jsx)("span", { children: `${(voice.durationMs / 1e3).toFixed(1)}s` })]
}), projectUserText(text, referenceLabels), rest.map((block, i) => (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.JsonBlock, {
		...
		*/
		...
		const en = {
			...
			"hero.headline": "Hi, I am Penglai",
			"hero.preview": "Local desktop assistant",
