...
test("forced stopChild termination is not a graceful application shutdown", async (context) => {
  ...
  const receipt = {
    ...
    installer: windowsHost ? "Penglai_0.6.5_windows_x64_setup.exe" : "Penglai_0.6.5_macos_aarch64.dmg",
...
test("publication workflow consumes the current 0.6.5 native evidence set and ten-asset contract", async () => {
